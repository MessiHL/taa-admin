//  by  https://vue-pure-admin.vercel.app/#/components/splitPane
	...
	setup(props, ctx) {
		...
		const onMouseMove = (e: any): void => {
			...
			if (active.value) {
				...
				if (percents > (props.splitSet?.minPercent || 0) && percents < 100 - (props.splitSet?.minPercent || 0)) {
			...
			<>
				...
				>
					...
					<resizer
						...
						onClick={() => onClick()}
					></resizer>
					<div class={unref(rightClass)} style={{ [unref(type)]: 100 - unref(percent.value || 0) + "%" }}>
						"ctx.slots.paneR"
					</div>
